...
/**
 * The default implementation of a path container.
 *
 * @author Vladimir Rybkin
 */
public class DefaultPathContainer extends PathContainer {

    /**
     * Known paths to layouts
     */
     ...
     * Constructor.
     *
     * @param tagKey Container tag
     * @param contextFactory Factory to use for context creation
     */
    public DefaultPathContainer(int tagKey, PathContextFactory contextFactory) {
        super(tagKey);
        mContextFactory = contextFactory;
    }

    @Override
    protected void performTraversal(final ViewGroup containerView, TraversalState traversalState,
